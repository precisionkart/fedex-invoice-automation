...
Uses the unified FedEx API endpoint (same host as Ship/Rates).
...
def upload_trade_document(
    ...
    Args:
        ...
        document_type:       FedEx doc types. Common values:
    ...
    url = f"{BASE_URL}/documents/v1/etds/upload"

    # The JSON metadata that describes the document + shipment
    document_metadata = {
        "document": {
    ...
    # FedEx expects multipart/form-data: the JSON metadata + binary file
    files = {
